...
if __name__== "__main__":
    ...
    if sys.argv[1].upper() == 'BTC':
        loc = 0.0021
        scale = 0.01457
    estimated_call_option_price = genCauchyCallOptionPrice(30,strike,spot,loc,scale,num_traces)
    print(estimated_call_option_price)
    generated_samples=[genCauchyCallOptionPrice(30,strike,spot,loc,scale,1000) for _ in range(500)]
